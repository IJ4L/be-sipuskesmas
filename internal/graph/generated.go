...
func (ec *executionContext) marshalNUser2githubᚗcomᚋIJ4LᚋinternalᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
